<?php include("includes/head.main.inc.php"); ?>
	...
	<div id="mainContent">
		<div class="break"></div>
		<p>
			<span class="rconfigNameStyle">rConfig</span> utilizes the Linux CRON daemon to run scheduled tasks. Currently you can create a two types of scheduled tasks. 
			<ul>
