	...
	<div id="mainContent">
		...
		<p>
			...
			<p>
				...
				Also, you can set the time zone on this page. It is important that you do this, as some backend scripts require this setting to be accurate.
			</p>
			<h4 class="helpH4">Device Settings</h4>
			<p>
				This sections has settings and information relating to devices. 
				The first three username/ password fields are used to auto-populate the username/password fields for the device add form on the Device page. 
				...
				<br/>Turn on Debug device output to get more verbise logging. Generally only used for support purposes.
				You can view, and delete debug logs here also
			</p>
